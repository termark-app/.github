...
Use [GitHub private vulnerability reporting](https://github.com/termark-app/termark/security/advisories/new) for issues involving the Termark desktop or mobile applications, update and distribution channels, authentication, local data protection, credential handling, sync, SSH/SFTP behavior, or official web services.
